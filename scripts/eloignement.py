...
def load_all_matrices(
    ...
    Mat_dist = create_symmetric_matrix(df_dt, device=device)
...
if __name__ == "__main__":
    ...
    # Chargement
    Mat_dist, Mat_infra, Mat_pop = load_all_matrices(
    ...
    Mat_Y = compute_remoteness_tensor(Mat_dist, Mat_infra, Mat_pop, clamp_max=args.clamp_max)
